...
from taskonomy_dataset import TaskonomyDatasetEuclidean, TaskonomyDatasetEuclideanAmir
...
def main():
    ...
    if args.mode == 'my':
        taskonomy_testset = TaskonomyDatasetEuclidean('../data/tiny5k_taskonomy_rgb_test.csv',
                                                      '/depth_euclidean',
                                                      'depth_euclidean.png',
                                                      resize256 = True,
                                                      ...
                                                      brenta = args.brenta)
    if args.mode == 'Amir':
        taskonomy_testset = TaskonomyDatasetEuclideanAmir('../data/tiny5k_taskonomy_rgb_test.csv',
                                                          '/depth_euclidean',
                                                          'depth_euclidean.png',
                                                          resize256 = True,
                                                          transform=taskonomy_transform,
