...
class TaskonomyDatasetEuclidean(torch.utils.data.Dataset):
    def __init__(self,
...
class TaskonomyDatasetEuclideanAmir(torch.utils.data.Dataset):
    def __init__(self,
                 path2images,                        # '../data/tiny_taskonomy_rgb_xxx.csv'
                 task_folder,                        # '/segment_semantic' or '/class_object', etc.
                 task_extension,                     # 'segmentsemantic.png' or 'class_1000.npy', etc.
...
if __name__=='__main__':
    ...
    taskonomy_trainset = TaskonomyDatasetEuclidean('../data/tiny_taskonomy_rgb_train.csv',
                                                   '/depth_euclidean',
                                                   'depth_euclidean.png',
                                                   resize256 = True,
