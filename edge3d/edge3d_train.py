...
from taskonomy_dataset import TaskonomyDatasetEdge3d
...
ckpt = './checkpoints/rgb2edge3d-ckpt.pth'
best = './checkpoints/rgb2edge3d-best.pth'

def main():
    taskonomy_transform = transforms.Compose([transforms.ToTensor(),
                                              transforms.Normalize((0.5456, 0.5176, 0.4863),
                                                                   (0.1825, 0.1965, 0.2172))])
    taskonomy_trainset = TaskonomyDatasetEdge3d('../data/tiny_taskonomy_rgb_train.csv',
                                                 '/edge_occlusion',
                                                 'edge_occlusion.png',
                                                 resize256 = True,
    ...
    taskonomy_testset = TaskonomyDatasetEdge3d('../data/tiny_taskonomy_rgb_test.csv',
                                                '/edge_occlusion',
                                                'edge_occlusion.png',
                                                resize256 = True,
                                                transform=taskonomy_transform,
