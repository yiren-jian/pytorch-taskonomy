...
class TaskonomyDatasetVanish(torch.utils.data.Dataset):
    def __init__(self,
    ...
    def __getitem__(self, idx):
        ...
        with open(target_name) as target_file:
            info = json.load(target_file)
            info = info['vanishing_points_gaussian_sphere']
...
if __name__=='__main__':
    ...
    taskonomy_trainset = TaskonomyDatasetVanish('../data/tiny_taskonomy_rgb_train.csv',
                                                   '/point_info',
                                                   'point_info.json',
                                                   resize256 = True,
